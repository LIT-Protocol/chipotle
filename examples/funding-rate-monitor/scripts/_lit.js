// Build the monitor code blob (lit-venues IIFE bundle + the action source)
...
// by monitor.js (to execute). Byte-identical code is what makes the CID
// pinning — and therefore the email-quota hygiene — hold.

const fs = require("fs");
const path = require("path");

const ACTION_FILE = path.join(__dirname, "..", "action", "funding-rate-monitor.js");
...
// setup.js calls this with retries on its smoke run; steady-state callers
// (monitor.js) leave retries at 0.
