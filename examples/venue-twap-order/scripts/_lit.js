// Compose the lit-venues bundle + the TWAP action into one executable, run it
...
const ACTION_FILE = path.join(__dirname, "..", "action", "twapOrder.js");
...
// errors. A trading tick must never be blind-retried — the failed attempt may
// already have placed an order venue-side (e.g. a response-parse error after
// a successful POST). Steady-state callers keep retries at 0.
