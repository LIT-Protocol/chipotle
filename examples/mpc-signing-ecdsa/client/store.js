...
//
// `.mpc-store.json` (the "hot" store) holds the user's hot keyshare (party 0),
// the action's keyshare sealed to its CID (relayed back into the action at sign
// time), and the public key / address. This is the user's half of the key: if
// it is lost the key can't be used for normal signing (and Lit alone still
// can't sign).
//
