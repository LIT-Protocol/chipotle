...
-- in deployed environments and is immutable — sqlx checksums each migration file
-- and refuses to boot if an applied one changes. All hardening that was briefly
-- (and wrongly) folded into 20260623000001 lives here instead.
--
