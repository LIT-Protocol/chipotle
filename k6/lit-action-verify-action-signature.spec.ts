 ...
 *
 * Usage:
 *   k6 run k6/lit-action-verify-action-signature.spec.ts
 *   BASE_URL=https://your-instance/core/v1 k6 run k6/lit-action-verify-action-signature.spec.ts
 *
...
export default function () {
  ...
  const newAccountRes = client.newAccount({
    account_name: "k6-lit-action-verify-action-signature",
