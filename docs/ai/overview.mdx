...
description: "Run your application or a vendor’s Docker container in confidential hardware, with verifiable software and on-chain approval of code and egress policy."
---
...
<Note>
AI deployments are arranged with the Lit team. This guide describes the container deployment method; it is not a self-serve Docker API or a promise of support for every model or accelerator. The crypto dashboard and Lit Actions API are separate entry points.
</Note>
