...
- **Size and response limits.** A big module plus its working state can bump into
  ...
  mpc-signing-ecdsa example relays large sealed blobs each round and documents the
...
<Info>
  ...
  [`wasm-demo/`](https://github.com/LIT-Protocol/chipotle/tree/main/examples/mpc-signing-ecdsa/wasm-demo)
