...
2. Run a Hello World LitAction
   1. [Run it from the Dashboard](https://dashboard.dev.litprotocol.com)
   2. [Call the API via cURL or JavaScript](#6-run-lit-action)
...
6. [Test lit-actions](#6-run-lit-actions)
