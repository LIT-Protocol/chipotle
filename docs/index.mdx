...
<Card title="Run AI in confidential hardware" icon="microchip" href="/ai/overview" horizontal>
  Bring your application or a vendor’s Docker container. Learn how measured egress policy, attestation, and on-chain release approval work together, then contact Lit to scope training or inference.
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Encrypted secrets" icon="lock" href="/lit-actions/secrets">
...
The two structural patterns production apps on Chipotle are built from. Both work with no PKP and no trusted backend.
