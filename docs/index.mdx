...
<Card title="Lit Agent Keychain" icon="key" href="/keychain" horizontal>
  Owner-approved, locally encrypted credentials for AI agents. Approve an agent's public key, and Lit's enclaves check your signature on every request. SDK, CLI and MCP server included.
</Card>
