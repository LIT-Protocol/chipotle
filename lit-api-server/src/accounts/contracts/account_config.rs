...
pub mod account_config {
    ...
    impl ::ethers::core::abi::AbiDecode for AccountConfigCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <AllApiKeyHashesCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <PricingCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for AccountConfigCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::AllApiKeyHashes(element) => ::ethers::core::abi::AbiEncode::encode(element),
