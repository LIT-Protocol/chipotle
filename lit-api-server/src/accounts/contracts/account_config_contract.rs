...
pub mod account_config {
    ...
    impl ::ethers::core::abi::AbiDecode for AccountConfigCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <SetSignerCountCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetSignerCount(decoded));
            }
            if let Ok(decoded) = <SignerCountCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for AccountConfigCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SetSignerCount(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::SignerCount(element) => ::ethers::core::abi::AbiEncode::encode(element),
