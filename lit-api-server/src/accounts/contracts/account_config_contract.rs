...
pub mod account_config {
    ...
    #[ethcall(name = "nodeConfigurationValue", abi = "nodeConfigurationValue(string)")]
    ...
    impl ::ethers::core::abi::AbiDecode for AccountConfigCalls {
        fn decode(
            ...
            if let Ok(decoded) = <AddActionCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ApiKeyCanExecuteForAnyGroupCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <CanExecuteActionCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CanExecuteAction(decoded));
            }
            if let Ok(decoded) = <CanExecuteActionAndUseWalletCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CanExecuteActionAndUseWallet(decoded));
            }
            if let Ok(decoded) = <CanExecuteActionFastCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CanExecuteActionFast(decoded));
            }
            if let Ok(decoded) = <CanUseWalletInActionCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CanUseWalletInAction(decoded));
            }
            if let Ok(decoded) = <CanUseWalletInActionFastCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <GroupIdsForActionCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GroupIdsForAction(decoded));
            }
            if let Ok(decoded) = <GroupIdsForActionAndWalletCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ListActionsInGroupCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <NodeConfigurationKeysCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NodeConfigurationKeys(decoded));
            }
            if let Ok(decoded) = <NodeConfigurationValueCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NodeConfigurationValue(decoded));
            }
            if let Ok(decoded) = <NodeConfigurationValuesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RemoveActionCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RemoveGroupCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetNodeConfigurationCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <UpdateGroupMetadataCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for AccountConfigCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::GroupIdsForAction(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::RemoveAction(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::RemoveActionFromGroup(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::RemoveGroup(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    pub struct GroupIdsForActionAndWalletReturn(
